...
<head>
    ...
    <title>Tambah Kategori - Eimei Highschool</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="d-flex">
        ...
        <main class="flex-grow-1 p-4 p-md-5">
            ...
            <div class="mb-4">
                ...
                <h1 class="fw-bold text-dark mb-0" style="font-size: 1.75rem;">Tambah Kategori Baru</h1>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 p-4" style="max-width: 600px;">
                <form action="{{ route('admin.categories.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control rounded-3 p-2.5 @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama') }}" placeholder="Contoh: Ekstrakurikuler" required>
                        @error('nama')
