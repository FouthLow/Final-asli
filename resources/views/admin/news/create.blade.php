...
<head>
    ...
    <title>Tambah Berita - Admin Galeri</title>
...
<body class="bg-gray-100 min-h-screen p-6">
    ...
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-bold text-gray-800">Tambah Berita / Foto</h2>
        ...
        <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                <label for="judul" class="block text-sm font-medium text-gray-700 mb-1">Judul Foto / Berita</label>
