...
<body class="py-5 bg-white">
    ...
    <div class="container" style="max-width: 900px;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            <h1 class="fw-bold mb-0" style="font-size: 1.75rem;">Tambah Data Siswa</h1>
        ...
        <form action="{{ route('admin.siswa.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nisn" name="nisn" value="{{ old('nisn') }}" required maxlength="10" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="form-control custom-input" placeholder="Masukkan 10 digit NISN...">
            </div>

            <div class="mb-4">
                <label for="nama" class="form-label">Nama Lengkap Siswa</label>
                <input type="text" id="nama" name="nama" value="{{ old('nama') }}" required class="form-control custom-input" placeholder="Masukkan nama siswa...">
            </div>
            ...
            <div class="mb-4">
                ...
                <select id="kelas" name="kelas" required class="form-select custom-input">
                    ...
                    @foreach ($kelasList as $item)
                        <option value="{{ $item->nama_kelas }}" {{ old('kelas') == $item->nama_kelas ? 'selected' : '' }}>
                            {{ $item->nama_kelas }}
                        </option>
                    @endforeach
                </select>
